...
function aboutPage() {            
    ...
    $("#center-button").animate({width: "1500px"}, 200, "linear", function() {
        $("#center-button").animate({height: "600px", top: "400.9px"}, 200, "linear", function() {
            ...
            $("#sliderleft").animate({width: "1262px", marginLeft: "248px"}, 500);
            $("#sliderright").animate({width: "25px"}, 500, function() {
                //page text
                document.getElementById("innertext").innerHTML = "I'm David/Zhiyuan/致远, a student at Swarthmore College in Swarthmore, Pennsylvania. <br> I'm a declared computer science major, set to graduate in May of 2018. <br> <br> Relevant interests include software development, building web pages, and generating creative solutions to technical problems. <br> Some of my skills include working with C, C++, Python, MySQL, and HTML/CSS/Javascript. <br> You can check out samples of my work over in the Projects section, or download my resume. <br> <br> <br> Outside of academics and programming, I love keeping physically fit, practicing my Chinese, and rock climbing/bouldering. <br> <br> My biggest hobby is playing video games, but nearly all of that time is devoted toward a single game, Super Smash Bros. Melee. <br> Currently, I am a professional-level player sponsored by EndGameTV. <br> See the Melee section for more info on my journey to the top!";
                $("#center-button").css({
                    "overflow-y": "hidden",
                    "overflow-x": "hidden"
                });
...
function projectsPage() {
    ...
    $("#center-button").animate({width: "1500px"}, 200, "linear", function() {
        $("#center-button").animate({height: "600px", top: "400.9px"}, 200, "linear", function() {
            ...
            $("#sliderleft").css({"opacity" : "1"});
            $("#sliderright").css({"opacity" : "1"});
            $("#sliderleft").animate({width: "1270px", marginLeft: "240px"}, 500);
            $("#sliderright").animate({width: "25px"}, 500, function() {
                //page text
...
function meleePage() {
    ...
    $("#center-button").animate({width: "1500px"}, 200, "linear", function() {
        $("#center-button").animate({height: "600px", top: "400.9px"}, 200, "linear", function() {
            ...
            $("#sliderleft").css({"opacity" : "1"});
            $("#sliderright").css({"opacity" : "1"});
            $("#sliderleft").animate({width: "1320px", marginLeft: "190px"}, 500);
            $("#sliderright").animate({width: "25px"}, 500, function() {
                //page text
                document.getElementById("innertext").innerHTML = "In the world of competitive Super Smash Bros. Melee, I am R2DLiu, a professional-level player sponsored by <a id='egtv' href='http://endgametv.esportsify.com/articles/news/gaming/21/welcome-r2dliu-to-egtv'>EndGameTV</a>. <br> I started playing competitively in 2014 as a Sheik player, and over the following year rose to the top of my region while switching to Fox, who has been my character of choice since. <br> <br> My Doc Kids article, which details my Melee biography, can be found <a id='dockids' href='http://peekand.co/this-week-in-e-sports/smash/doc-kids/r2dliu/'>here<a>. <br> You can also read my <a id='ssbwiki' href='https://www.ssbwiki.com/Smasher:R2DLiu'>ssbwiki profile<a> for my tournament history and player card. <br> <br> Check back later to see my upcoming tournament attendance and future blog!";
                $("#egtv").css({
...
function contactPage() {
    ...
    $("#center-button").animate({width: "1500px"}, 200, "linear", function() {
        $("#center-button").animate({height: "600px", top: "400.9px"}, 200, "linear", function() {
            ...
            $("#sliderleft").css({"opacity" : "1"});
            $("#sliderright").css({"opacity" : "1"});
            $("#sliderleft").animate({width: "1280px", marginLeft: "230px"}, 500);
            $("#sliderright").animate({width: "25px"}, 500, function() {
                //page text
                document.getElementById("innertext").innerHTML = "";
                $("#center-button").css({
